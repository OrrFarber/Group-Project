...
export default function ContextData() {
    ...
    const exerciseTyppe = userValues[conectedUser]?.exerciseType
    const UserWorkouts = async () => {
        const muscleGroupp = userValues[conectedUser]?.muscleGroup
        const options = {
            method: 'GET',
        ...
        console.log(exerciseTyppe);
        console.log(userValues[conectedUser]);
        console.log(typeof(userValues[conectedUser]?.difficulty));
